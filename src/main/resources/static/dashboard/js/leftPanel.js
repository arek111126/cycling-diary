function removeStatisticTable(currentElem) {
    ...
    if (navItem.eq(0).hasClass("active")) {
        ...
        $("#cardToDelate1").fadeOut(250, function () {
            $(this).remove();
        });
        $("#traningDate1").fadeOut(250, function () {
            $(this).remove();
        });
        $("#traningDate2").fadeOut(250, function () {
            $(this).remove();
        });
        $("#btnFilter").fadeOut(250, function () {
            $(this).remove();
        })
        navItem.removeClass("active");
        $(currentElem).addClass("active");
    } else if (navItem.eq(2).hasClass("active")) {

        $(".content").removeAttr("id");
        $("#chartContainer1").fadeOut(250, function () {
            $("#chartContainer1").remove();
        });
        $("#chartContainer2").fadeOut(250, function () {
            $("#chartContainer2").remove();
        });
        $("#chartContainer3").fadeOut(250, function () {
            $("#chartContainer3").remove();
        });
        $("#chartContainer4").fadeOut(250, function () {
...
$("#classificationButton").on('click', function () {
    ...
    if ($("#classificationButton").hasClass("active")) {
        return
    }
...
$("#trainingListButton").on("click", function () {
    if ($("#trainingListButton").hasClass("active")) {
        return
    }
    removeStatisticTable(this);
    $.ajax({
